...
DOTFILES_DIR=~/Playground/dotfiles
...
alias r!="source ~/.bash_profile; echo 'bash_profile loaded'" # reload bash
...
alias ebash="$EDITOR $DOTFILES_DIR/install/setup/bash/shell_config"
